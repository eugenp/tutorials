...
public class Utils {
    ...
    public static PrivateKey getPrivateKey() throws Exception {
        ...
        keyStore.load(new FileInputStream("src/main/resources/digitalsignature/" + SENDER_KEYSTORE), PASSWORD);
        return (PrivateKey) keyStore.getKey(SENDER_ALIAS, PASSWORD);
    }

    public static PublicKey getPublicKey() throws Exception {
        KeyStore keyStore = KeyStore.getInstance(STORE_TYPE);
        keyStore.load(new FileInputStream("src/main/resources/digitalsignature/" + RECEIVER_KEYSTORE), PASSWORD);
