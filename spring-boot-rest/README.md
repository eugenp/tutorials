...
5. [Error Handling for REST with Spring](http://www.baeldung.com/exception-handling-for-rest-with-spring)
6. [REST API Discoverability and HATEOAS](http://www.baeldung.com/restful-web-service-discoverability)
7. [An Intro to Spring HATEOAS](http://www.baeldung.com/spring-hateoas-tutorial)
