...
public class DeprecatedJsonParserUnitTest {
    ...
    @Test
    public void givenJsonString_whenParseUsingParseString_thenJsonObjectIsExpected1() {
        JsonObject jsonObjectAlt = JsonParser.parseString(jsonString).getAsJsonObject();
        assertEquals(expectedJsonObject, jsonObjectAlt);
    }

    @Test
    public void givenJsonString_whenParseUsingParseReader_thenJsonObjectIsExpected2() {
    ...
    @Test
    public void givenJsonString_whenParseUsingJsonReader_thenJsonObjectIsExpected3() {
