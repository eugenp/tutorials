...
import com.baeldung.repositories.EmployeeProjectionRepository;
...
@ActiveProfiles("expose-projections,h2")
public class EmployeeProjectionExposingIdsIntegrationTest {
    ...
    @Autowired
    private EmployeeProjectionRepository repository;
