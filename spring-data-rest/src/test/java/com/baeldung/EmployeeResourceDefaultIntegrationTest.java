...
public class EmployeeResourceDefaultIntegrationTest {
    ...
    @Test
    public void whenAllEmployeesAreRequested_thenIDsAreMissing() throws Exception {
        mockMvc.perform(get("/employees"))
                .andDo(print())
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("$._embedded.employees[0].id").doesNotExist());
    }
