...
public class JacksonMappingExceptionUnitTest {
    ...
    @Test
    public void givenJsonArray_whenDeserializingToMap_thenThrowException() throws JsonProcessingException {
    ...
    public void givenJsonArray_whenDeserializingToListOfMap_thenConvert() throws JsonProcessingException {
        ...
        List<Map<String, String>> personList = mapper.readValue(json, new TypeReference<List<Map<String, String>>>() {});
