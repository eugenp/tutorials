package com.baeldung.kafkaexception;
...
public class HandleInstanceAlreadyExistsException {
    ...
    public static void useUniqueObjectName() throws Exception {
        ...
        ObjectName objectName1 = new ObjectName("com.example:type=MyMBean,id=producer1");
        ObjectName objectName2 = new ObjectName("com.example:type=MyMBean,id=producer2");
