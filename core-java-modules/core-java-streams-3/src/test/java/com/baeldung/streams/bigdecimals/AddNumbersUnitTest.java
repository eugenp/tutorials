...
public class AddNumbersUnitTest {
    ...
    @Test
    public void givenIntStream_whenSum_thenEnsureSumResultIsCorrect() {
        IntStream intNumbers = IntStream.range(0, 3);
        assertEquals(3, intNumbers.sum());
    }

    @Test
    public void givenCollectionOfDouble_whenUsingMapToDoubleToSum_thenEnsureSumResultIsCorrect() {
    ...
    public void givenStreamOfIntegers_whenUsingReduceToSum_thenEnsureSumResultIsCorrect() {
        Stream<Integer> intNumbers = Stream.of(0, 1, 2);
        int result = intNumbers.reduce(0, Integer::sum);
        assertEquals(106, result);
    }

    public void givenStreamOfBigDecimals_whenUsingReduceToSum_thenEnsureSumResultIsCorrect() {
