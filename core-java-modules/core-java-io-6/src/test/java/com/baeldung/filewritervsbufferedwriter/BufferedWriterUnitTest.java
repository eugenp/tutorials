...
public class BufferedWriterUnitTest {
    ...
    @Test
    public void whenWritingUsingBufferedWriter_thenContentIsCorrect() throws IOException {
    ...
    @Test
    public void whenBufferedFileIsWritten_thenFileExists() throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH));
