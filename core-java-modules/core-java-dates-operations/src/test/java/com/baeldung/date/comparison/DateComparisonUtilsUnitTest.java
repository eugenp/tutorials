...
public class DateComparisonUtilsUnitTest {
	...
	Date day1Morning = toDate(LocalDateTime.of(2019, 10, 19, 6, 30, 40));
	Date day1Evening = toDate(LocalDateTime.of(2019, 10, 19, 18, 30, 50));
	Date day2Morning = toDate(LocalDateTime.of(2019, 10, 20, 6, 30, 50));
