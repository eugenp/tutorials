...
@RunWith(MockitoJUnitRunner.class) public class AnimalInfoJUnitAdapter {
        ...
        @Test public void whenRunningForValidAnimalName_shouldReturnCorrectAnimalClass() {
        ...
        @Test public void whenRunningForInvalidAnimalName_shouldReturnDefaultResponse() {
                Animal animal = new Animal("testName", "testClass");
