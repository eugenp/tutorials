...
public class ShallowCopyExampleTest {
    ...
    public void testShallowCopy() {
	        ...
	        shallowCopyCar.getEngine().setChessisNumber("V8"); // V8 is new chessis number
	
	        Assertions.assertEquals("Toyota", originalCar.getMake()); //  
	        Assertions.assertEquals("Camry", originalCar.getModel());
	
	        // Since it's a shallow copy, changes in the internal references affect the original object
