...
public class RoundDate {
    ...
    public static LocalDateTime roundToStartOfMonth(LocalDateTime dateTime) {
        return dateTime.withDayOfMonth(1).withHour(0).withMinute(0).withSecond(0).withNano(0);
    }

    public static LocalDateTime roundToEndOfWeek(LocalDateTime dateTime) {
    ...
    public static ZonedDateTime roundToStartOfMonth(ZonedDateTime dateTime) {
