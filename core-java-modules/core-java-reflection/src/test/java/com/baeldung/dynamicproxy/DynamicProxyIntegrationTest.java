...
public class DynamicProxyIntegrationTest {
    ...
    public void givenDynamicProxy_thenPutWorks() {
        Map<Object, Object> proxyInstance = (Map<Object, Object>) Proxy.newProxyInstance(DynamicProxyIntegrationTest.class.getClassLoader(),
    ...
    public void givenTimingDynamicProxy_thenMethodInvokationsProduceTiming() {
        Map<Object, Object> mapProxyInstance = (Map<Object, Object>) Proxy.newProxyInstance(DynamicProxyIntegrationTest.class.getClassLoader(),
        ...
        CharSequence csProxyInstance = (CharSequence) Proxy.newProxyInstance(
                DynamicProxyIntegrationTest.class.getClassLoader(), new Class[] { CharSequence.class },
