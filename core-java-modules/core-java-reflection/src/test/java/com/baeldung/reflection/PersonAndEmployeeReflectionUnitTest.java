...
public class PersonAndEmployeeReflectionUnitTest {
  ...
  public void givenPersonClass_whenGetDeclaredFields_thenTwoFields() {
    ...
    assertTrue(Arrays.stream(allFields).anyMatch(field -> field.getName().equals(LAST_NAME_FIELD)
        && field.getType().equals(String.class)));
    assertTrue(Arrays.stream(allFields).anyMatch(field -> field.getName().equals(FIRST_NAME_FIELD)
        && field.getType().equals(String.class)));
  }
  ...
  public void givenEmployeeClass_whenGetDeclaredFields_thenOneField() {
    ...
    assertTrue(Arrays.stream(allFields).anyMatch(field -> field.getName().equals(EMPLOYEE_ID_FIELD)
  ...
  public void givenEmployeeClass_whenGetDeclaredFieldsOnBothClasses_thenThreeFields() {
    ...
    Arrays.setAll(allFields,
        i -> (i < personFields.length ? personFields[i] : employeeFields[i - personFields.length]));
  ...
  public void givenEmployeeClass_whenGetDeclaredFieldsOnEmployeeSuperclassWithModifiersFilter_thenOneFields() {
    ...
    assertTrue(personFields.stream().anyMatch(field -> field.getName().equals(LAST_NAME_FIELD)
        && field.getType().equals(String.class)));
  }
  ...
  public void givenMonthEmployeeClass_whenGetAllFields_thenThreeFields() {
    ...
    assertTrue(allFields.stream().anyMatch(field -> field.getName().equals(LAST_NAME_FIELD)
        && field.getType().equals(String.class)));
    assertTrue(allFields.stream().anyMatch(field -> field.getName().equals(EMPLOYEE_ID_FIELD)
        && field.getType().equals(int.class)));
    assertTrue(allFields.stream().anyMatch(field -> field.getName().equals(MONTH_EMPLOYEE_REWARD_FIELD)
