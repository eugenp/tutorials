...
class FizzBuzzUnitTest {
    ...
    private static final List<String> GROUND_TRUTH_SEQUENCE_LENGTH_5 = generateGroundTruth(5);

    private static final List<String> GROUND_TRUTH_SEQUENCE_LENGTH_100 = generateGroundTruth(100);
