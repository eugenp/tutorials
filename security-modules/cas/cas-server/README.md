...
在启动CAS服务器之前，我们需要添加一些基本配置。让我们首先在这个文件夹中创建一个 cas-server/src/main/resources 文件夹。随后将创建应用程序配置 application.properties 。文件夹中的属性：
...
让我们更新 CasSecuredApplication 中的 CasAuthenticationProvider() ，使其具有与CAS服务器相同的用户名：
