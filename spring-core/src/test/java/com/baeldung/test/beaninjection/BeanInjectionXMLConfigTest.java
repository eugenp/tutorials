	...
	private ApplicationContext beanInjectedContext;
	 ...
	 @Test
	  public void testDAOInjectionByXML() {
		 	...
		 	assertTrue("Failed: Constructor Injection,String Property , XML Config", serviceBean.getPropertyX().equals("Some Service Property X"));
	  }
	 
	 @Test
	  public void testPropertyInjectioninDAOByXML() {
		 	ExampleDAOBean daoBean=beanInjectedContext.getBean(ExampleDAOBean.class);
		 	assertTrue("Failed: Constructor Injection,String Property , XML Config", daoBean.getPropertyX().equals("Mandatory DAO Property X"));
