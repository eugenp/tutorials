...
public class JavaConfigConstructorInjectionTest {

    @Test
    public void givenJavaConfig_WhenConstructorInjection_ThenValidDependency() {
        ApplicationContext context = new AnnotationConfigApplicationContext(JavaConfig.class);

        Book book = (Book) context.getBean("bookJavaConstructor");
