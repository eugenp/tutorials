...
import static com.baeldung.proxyauth.ProxiedSpringRestTemplate.createClient;
...
class ProxiedSpringRestTemplateIntegrationTest {
    ...
    void givenAuthenticatedProxy_whenSendRequest_thenSuccess() {
        ...
        RestTemplate restTemplate = createClient(authProxyConfig);
        String response = sendRequest(restTemplate, "http://localhost:" + resourcePort + "/secure");
