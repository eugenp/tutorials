...
@RestClientTest({ BookProducer.class, Application.class })
public class DetailsServiceClientIntegrationTest {

    @Autowired
    private BookProducer client;
    ...
    public void setUp() throws Exception {
        String detailsString = objectMapper.writeValueAsString(new Book("John Smith", "john"));
