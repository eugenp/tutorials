...
public class BusinessWorkerUnitTest {
    ...
    public void whenUsingPattern_thenReturnExpectedResult() {
        ...
        assertThat(memoryAppender.containsPattern(".*Order ID: \\d{5}.*", Level.INFO)).isTrue();
        assertThat(memoryAppender.containsPattern(".*Order ID: \\d{5}.*", Level.WARN)).isTrue();
        assertThat(memoryAppender.containsPattern(".*Order ID: \\d{5}.*", Level.ERROR)).isTrue();
        assertThat(memoryAppender.containsPattern(".*Order ID: \\d{5}.*", Level.TRACE)).isFalse();
    }
