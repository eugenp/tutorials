...
@SpringBootTest
public class BeforeMethodUnitTest extends AbstractTestNGSpringContextTests {
    private static final Logger log = LoggerFactory.getLogger(BeforeMethodUnitTest.class);
