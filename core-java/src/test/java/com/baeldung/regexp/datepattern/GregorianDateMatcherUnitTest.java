...
public class GregorianDateMatcherUnitTest {
    ...
    public void whenDateIsInRestrictedRange_thenPatternMatches() {
        Assert.assertTrue(matcher.match("1900-01-01"));
        Assert.assertTrue(matcher.match("2205-05-25"));
        Assert.assertTrue(matcher.match("2999-12-31"));
    }

    @Test
    public void whenDateIsOutOfRestrictedRange_thenNoMatch() {
        Assert.assertFalse(matcher.match("1899-12-31"));
        Assert.assertFalse(matcher.match("3000-01-01"));
    }
    ...
    public void whenYearIsLeap_thenFebHas29Days() {
        ...
        Assert.assertTrue(matcher.match("2800-02-29"));
        Assert.assertTrue(matcher.match("2004-02-29"));
        Assert.assertTrue(matcher.match("2008-02-29"));
        Assert.assertTrue(matcher.match("2012-02-29"));
        Assert.assertTrue(matcher.match("2016-02-29"));
        Assert.assertTrue(matcher.match("2020-02-29"));
    }

    @Test
    public void whenYearIsNotLeap_thenFebHasNo29Days() {
        Assert.assertFalse(matcher.match("2017-02-29"));
        Assert.assertFalse(matcher.match("2018-02-29"));
        Assert.assertFalse(matcher.match("2019-02-29"));
