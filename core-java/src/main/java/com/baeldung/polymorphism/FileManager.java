...
public class FileManager {
    ...
    public static void createImageFile(String name, int height, int width, byte[] content, String version) {
        ImageFile imageFile = new ImageFile(name, height, width, content, version);
        System.out.println("File 2 Info: \n" + imageFile.getFileInfo());
    }

    public static void createTextFile(String name, String content, String version) {
