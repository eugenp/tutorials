...
<body ng-controller="socketController">
    ...
    <div>
        ...
        <div>
            ...
            <button id="authenticate" ng-click="authenticate('${context}');">Connect and Authenticate</button>
    ...
    <a href="${pageContext.request.contextPath}/secured/success">Click to go back!</a>
