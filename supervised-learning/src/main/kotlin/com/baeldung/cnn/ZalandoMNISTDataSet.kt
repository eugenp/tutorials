...
class ZalandoMNISTDataSet {
    ...
    fun load(): MutableList<List<String>> {
        val labelsFile = File("supervised-learning/src/main/resources/train-labels-idx1-ubyte")
        val imagesFile = File("supervised-learning/src/main/resources/train-images-idx3-ubyte")
