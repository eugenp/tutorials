...
public class SpringRetryDeclarativeTest {
    ...
    @Test(expected = RuntimeException.class)
    public void customRetryServiceIOException() throws SocketTimeoutException, SQLException {
        myService.customRetryService("SQL");
    }

    @Test
    public void customRetryServiceSQLException() throws SocketTimeoutException, SQLException {
