...
public class SQSApplication {
    ...
    static {
        ...
        credentials = new BasicAWSCredentials(
            "AKIAJT5NV2MTK6PGJY6A", 
            "kJzphlwtQlfSoU9XcjAV1kS/08K4+TeLvA5zF2tQ"
        );
    }
...
//
//        String deadLetterQueueARN = queueAttributes.getAttributes().get("QueueArn");
//
//        
//        SetQueueAttributesRequest queueAttributesRequest = new SetQueueAttributesRequest()
//            .withQueueUrl("https://sqs.us-east-1.amazonaws.com/771412604156/baeldung-queue")
...
//            .withMessageBody("Standard Queue")
...
//        messageEntries.add(new SendMessageBatchRequestEntry().withId("id-1").withMessageBody("batch-1").withMessageGroupId("baeldung-group-1"));
//        messageEntries.add(new SendMessageBatchRequestEntry().withId("id-2").withMessageBody("batch-2").withMessageGroupId("baeldung-group-1"));
//        
//        
//        SendMessageBatchRequest sendMessageBatchRequest = new SendMessageBatchRequest(q, messageEntries); 
//        sqs.sendMessageBatch(sendMessageBatchRequest);
//
//        // Read a message from a queue
//        
//        ReceiveMessageRequest receiveMessageRequest = new ReceiveMessageRequest("https://sqs.us-east-1.amazonaws.com/771412604156/baeldung-queue.fifo")
...
//            .withQueueUrl("https://sqs.us-east-1.amazonaws.com/771412604156/baeldung-queue.fifo")
