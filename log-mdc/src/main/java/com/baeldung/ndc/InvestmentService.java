...
/**
 * A fake savings/investment service.
 */
public abstract class InvestmentService {

    /**
     * Sample service transferring a given amount of money based on destination.
     * @param amount
     * @param destination - can be an savingsAccountId or investmentFundId
     * @return {@code true} when the transfer complete successfully, {@code false} otherwise.
     */
    public boolean transfer(long amount, String destination) {
        beforeTransfer(amount);
        // Act based on the nature of destination account
