...
public class TestcontainersManager implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        orderService = new GenericContainer<>(DockerImageName.parse("quarkus/order-service-jvm:latest"))
        ...
        String orderInfoUrl = String.format("http://%s:%s/orderapi/v1",
                orderService.getHost(), orderService.getMappedPort(8080));
