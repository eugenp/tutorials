...
public class JiraClient_bak {
    ...
    public static void main(String[] args) {
        ...
        final JiraRestClient restClient = factory.createWithBasicHttpAuthentication(jiraServerUri, "yasin.bhojawala", "jira@P455");
        try {
            final Promise<Issue> issuePromise = restClient
              .getIssueClient()
              .getIssue("BAEL-1139");
            final Issue issue = issuePromise.claim();
