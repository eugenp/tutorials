...
import static com.baeldung.patterns.ScoringRules.moreOfSameKind;
import static com.baeldung.patterns.ScoringRules.pairs;
import static com.baeldung.patterns.ScoringRules.specificValue;
...
import com.baeldung.patterns.data.Strategies.OnePair;
import com.baeldung.patterns.data.Strategies.Ones;
import com.baeldung.patterns.data.Strategies.ThreeOfaKind;
import com.baeldung.patterns.data.Strategies.TwoPairs;
import com.baeldung.patterns.data.Strategies.Twos;
...
public class Yahtzee {
    ...
    static Supplier<Integer> diceValueGenerator = () -> ThreadLocalRandom.current()
        .nextInt(1, 7);
