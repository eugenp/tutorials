...
import static com.baeldung.patterns.Yahtzee.chooseStrategy;
import static com.baeldung.patterns.Yahtzee.rerollValues;
import static com.baeldung.patterns.Yahtzee.roll;
import static com.baeldung.patterns.Yahtzee.score;
...
class YahtzeeTest {
    ...
    public static Stream<Arguments> whenThePlayerChoosesAStrategy_thenCalculateCorrectScore() {
        return Stream.of(Arguments.of(List.of(3, 3, 3, 4, 4), "ONE_PAIR", 8), Arguments.of(List.of(3, 3, 3, 4, 4), "THREE_OF_A_KIND", 9),
            Arguments.of(List.of(1, 2, 2, 4, 4), "ONE_PAIR", 8), Arguments.of(List.of(1, 2, 2, 2, 5), "THREE_OF_A_KIND", 6),
            Arguments.of(List.of(1, 1, 1, 1, 5), "ONE_PAIR", 2), Arguments.of(List.of(1, 1, 1, 1, 5), "THREE_OF_A_KIND", 3));
    }
