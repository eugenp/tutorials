...
import com.baeldung.web.filter.CachingHttpHeadersFilter;
 ...
 */
@Configuration public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    @Autowired(required = false) private MetricRegistry metricRegistry;
    ...
    @Bean @ConditionalOnProperty(name = "jhipster.cors.allowed-origins") public CorsFilter corsFilter() {
