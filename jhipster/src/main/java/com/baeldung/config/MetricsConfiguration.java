...
@Configuration @EnableMetrics(proxyTargetClass = true) public class MetricsConfiguration extends MetricsConfigurerAdapter {
    ...
    @Autowired(required = false) private HikariDataSource hikariDataSource;

    @Override @Bean public MetricRegistry getMetricRegistry() {
        return metricRegistry;
    }

    @Override @Bean public HealthCheckRegistry getHealthCheckRegistry() {
    ...
    @Configuration @ConditionalOnClass(Graphite.class) public static class GraphiteRegistry {
    ...
    @Configuration @ConditionalOnClass(SparkReporter.class) public static class SparkRegistry {
