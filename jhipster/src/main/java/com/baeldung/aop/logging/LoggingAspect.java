...
@Aspect public class LoggingAspect {
    ...
    @Pointcut("within(com.baeldung.repository..*) || within(com.baeldung.service..*) || within(com.baeldung.web.rest..*)") public void loggingPointcut() {
    }

    @AfterThrowing(pointcut = "loggingPointcut()", throwing = "e") public void logAfterThrowing(JoinPoint joinPoint, Throwable e) {
    ...
    @Around("loggingPointcut()") public Object logAround(ProceedingJoinPoint joinPoint) throws Throwable {
