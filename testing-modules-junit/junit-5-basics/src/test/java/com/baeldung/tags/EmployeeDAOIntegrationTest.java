...
public class EmployeeDAOIntegrationTest {
    ...
    //This is throwing an error - after the test is run once, the first name is being stored + a duplicate key error is thrown:
    // EmployeeDAOIntegrationTest.testAddEmployeeUsingSimpelJdbcInsert:47 » DuplicateKey
/*    @Test
    @Tag("IntegrationTest")
    public void testAddEmployeeUsingSimpelJdbcInsert() {
        final Employee emp = new Employee();
        emp.setId(12);
        emp.setFirstName("testFirstName1");
