...
public class ArtistJpaAdapterTest {
    ...
    @Captor
    private ArgumentCaptor<ArtistEntity> artistEntityArgumentCaptor;

    @Test
    void givenArtist_whenAddArtist_thenEntityIsPortedToRepository() {
        ...
        final ArtistEntity artistEntity = artistEntityArgumentCaptor.getValue();
        assertThat(artistEntity.getName()).isEqualTo(TEST_ARTIST_NAME);
    }

    @Test
    void givenArtist_whenRemoveArtist_thenEntityRemovalIsPortedToRepository() {
        final ArtistDto testArtistDto = ArtistDto.builder()
            .name(TEST_ARTIST_NAME)
            .build();
    ...
    @Test
    void givenCallToAllArtists_whenNoParams_thenFindAllIsPortedToRepository() {
