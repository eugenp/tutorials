...
@ExtendWith(MockitoExtension.class) public class ArtistServiceAdapterTest {

        @InjectMocks private ArtistServiceAdapter artistServicePort;

        @Mock private ArtistPersistencePort artistPersistencePort;

        @Mock private List<ArtistDto> mockArtistDtoList;

        @Test public void givenArtist_whenAdd_thenAddPortCalled() {
        ...
        @Test public void givenArtist_whenRemove_thenRemovePortCalled() {
                final ArtistDto mockArtistDto = mock(ArtistDto.class);
        ...
        @Test public void givenCallToAllArtists_whenNothingSpecified_thenGetAllArtistsPortCalled() {
        ...
        @Test public void givenArtistId_whenGetArtistsById_thenGetArtistByIdPortCalled() {
