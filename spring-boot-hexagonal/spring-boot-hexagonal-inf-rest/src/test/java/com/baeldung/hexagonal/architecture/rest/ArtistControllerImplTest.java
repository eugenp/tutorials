...
public class ArtistControllerImplTest {
    ...
    @Test
    void givenArtist_whenAddArtist_thenEntityIsPortedToService() throws Exception {
    ...
    @Test
    void givenArtist_whenRemoveArtist_thenEntityRemovalIsPortedToService() throws Exception {
        final ArtistDto testArtistDto = ArtistDto.builder()
            .name(TEST_ARTIST_NAME)
            .build();
    ...
    @Test
    void givenCallToAllArtists_whenNoParams_thenFindAllIsPortedToService() throws Exception {
        final ArtistDto testArtistDto = ArtistDto.builder()
            .name(TEST_ARTIST_NAME)
            .build();
