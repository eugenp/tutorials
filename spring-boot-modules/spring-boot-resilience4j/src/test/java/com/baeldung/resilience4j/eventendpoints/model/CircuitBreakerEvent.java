...
public class CircuitBreakerEvent {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(circuitBreakerName, that.circuitBreakerName) && Objects.equals(type, that.type) && Objects.equals(creationTime, that.creationTime) && Objects.equals(errorMessage, that.errorMessage) && Objects.equals(durationInMs, that.durationInMs) && Objects.equals(stateTransition, that.stateTransition);
    }

    @Override
    public int hashCode() {
        return Objects.hash(circuitBreakerName, type, creationTime, errorMessage, durationInMs, stateTransition);
    }
