...
public class EditorUnitTest {
        ...
        */
        ...
        private void persistAndVerify(EntityManagerFactory entityManagerFactory, Editor editor) throws Exception {              
                ...
                assertThat(
                    loadedEditor.getAssignedAuthors()).onProperty("authorName").containsOnly( "Maria", "Mike" );
                Map<String, Author> authors = loadedEditor.getAssignedAuthors().stream().collect(
                    Collectors.toMap(Author::getAuthorName, e->e));
                assertThat(
                    authors.get("Maria").getAuthoredArticles()).onProperty("articleTitle").containsOnly(
                        "Basic of Hibernate OGM");
                assertThat(
                    authors.get("Mike").getAuthoredArticles()).onProperty("articleTitle").containsOnly(
                        "Intermediate of Hibernate OGM", "Advanced of Hibernate OGM");
                entityManager.close();
                transactionManager.commit();
        }
        ...
        private Editor generateTestData() {
                ...
                Article basic = new Article(
                    "Basic of Hibernate OGM", "https://publishing.com/hibernate/ogm/basic");
                Article intermediate = new Article(
                    "Intermediate of Hibernate OGM", "https://publishing.com/hibernate/ogm/intermediate");
                Article advanced = new Article(
                    "Advanced of Hibernate OGM", "https://publishing.com/hibernate/ogm/advanced");
