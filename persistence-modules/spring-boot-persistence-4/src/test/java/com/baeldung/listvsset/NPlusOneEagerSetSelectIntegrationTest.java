...
import com.baeldung.listvsset.eager.setselect.Application;
import com.baeldung.listvsset.eager.setselect.Comment;
import com.baeldung.listvsset.eager.setselect.Group;
import com.baeldung.listvsset.eager.setselect.Post;
import com.baeldung.listvsset.eager.setselect.User;
...
class NPlusOneEagerSetSelectIntegrationTest extends BaseNPlusOneIntegrationTest<User> {
    ...
    void givenEagerListBasedUser_WhenFetchingAllUsers_ThenIssueNPlusOneRequests(
      ToIntFunction<List<User>> function) {
    ...
    private int countNumberOfRequests(Optional<User> optionalUser) {
        ...
        visitedMap.put(GROUPS, new HashSet<>());
        int result = 2;
