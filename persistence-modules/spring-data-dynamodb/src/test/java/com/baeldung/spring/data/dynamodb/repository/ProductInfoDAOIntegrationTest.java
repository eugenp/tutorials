...
import com.baeldung.spring.data.dynamodb.dao.ProductInfoDAO;
...
public class ProductInfoDAOIntegrationTest {
    ...
    public static void setupClass() {
        Properties testProperties = loadFromFileInClasspath("application.properties")
                .filter(properties -> !StringUtils.isEmpty(properties.getProperty(AWS_ACCESSKEY)))
                .filter(properties -> !StringUtils.isEmpty(properties.getProperty(AWS_SECRETKEY)))
                .filter(properties -> !StringUtils.isEmpty(properties.getProperty(DYNAMODB_ENDPOINT)))
    ...
    public void setup() throws Exception {
        ...
        dynamoDBMapper.batchDelete((List<ProductInfo>) dao.findAll());
    }
    ...
    public void givenItemWithExpectedCost_whenRunFindAll_thenItemIsFound() {
        ...
        List<ProductInfo> result = (List<ProductInfo>) dao.findAll();
