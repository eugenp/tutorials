...
public class EmployeeDaoJpa {
        ...
        public List<Employee> searchEmployeesInsecure(String name) {
                ...
                try {
                        return entityManager.createQuery("select emp from Employee emp where emp.name like '" + name + "'").getResultList();
                } finally {
                        entityManager.close();
                }
        }
        ...
        public List<Employee> searchEmployeesSecure1(String name) {
                ...
                try {
                        ...
                        return jpqlQuery.setParameter(1, name).getResultList();
        ...
        public List<Employee> searchEmployeesSecure2(String name) {
                ...
                try {
                        ...
                        return jpqlQuery.setParameter("empname", name).getResultList();
                } finally {
                        entityManager.close();
                }
