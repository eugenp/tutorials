package com.baeldung.disablingscheduledtasks.integration.replacewithmock;
...
import com.baeldung.disablingscheduledtasks.config.replacewithmock.ApplicationConfig;

@SpringBootTest(
    classes = { ApplicationConfig.class, SchedulerTestConfiguration.class },
    properties = { "notification.send.out.delay: 10" }
)
@MockBean(DelayedNotificationScheduler.class)
