package org.baeldung.custom.validation.msgsrc;
...
import com.baeldung.custom.validation.msgsrc.AppConfig;
import com.baeldung.custom.validation.msgsrc.LoginController;
import com.baeldung.custom.validation.msgsrc.CustomMsgSrcApplication;

@RunWith(SpringRunner.class)
@WebMvcTest(value = LoginController.class, secure = false)
@ContextConfiguration(classes = { CustomMsgSrcApplication.class, AppConfig.class})
