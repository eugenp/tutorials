...
public class EmployeeRepositoryImpl implements EmployeeRepository {
    ...
    private static final String INSERT_BOOKS_SQL = "INSERT INTO employees" + " (id, firstName, lastName, code) VALUES " + " (?, ?, ?, ?);";
    private static final String DELETE_BOOKS_SQL = "DELETE FROM employees WHERE id = '%s'";

    @Override
    public void save(Employee employee) {
        try (Connection connection = MySQLConnectionFactory.getConnection(); PreparedStatement preparedStatement = connection.prepareStatement(INSERT_BOOKS_SQL)) {
