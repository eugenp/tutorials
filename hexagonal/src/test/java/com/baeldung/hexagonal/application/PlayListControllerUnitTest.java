...
public class PlayListControllerUnitTest {
    ...
    @Test
    public void givenPlayList_whenIdIsOne_thenPlaylistContainsTwoSongs() {
    ...
    @Test
    public void givenPlaylist_whenHasTwoSongs_thenAddSong() {
        PlayList playList = controller.getPlayList(1L);
        assertThat(playList).isNotNull();
        assertThat(playList.getAllSongs()
            .size()).isEqualTo(2);
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    public void givenPlayList_whenHasTwoSongs_thenRemoveSong() {
        PlayList playList = controller.getPlayList(1L);
        assertThat(playList).isNotNull();
        assertThat(playList.getAllSongs()
            .size()).isEqualTo(2);
