...
public class MultitenantSchemaIntregrationTest {
    
    @Test
    public void givenSchemaMode_whenFetchingSuppliersByName_thenChecking() throws UnsupportedTenancyException, IOException {
