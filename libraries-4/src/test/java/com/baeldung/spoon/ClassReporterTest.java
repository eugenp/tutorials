...
public class ClassReporterTest {
    ...
    public void givenBrokenClass_whenGenerateReport_thenSuccess() {
        var reporter = new ClassReporter();
        var report = reporter.generateMethodSummaryReport("src/test/resources/spoon/BrokenClass.java");
    ...
    public void whenGenerateReport_thenSuccess() {
        ...
        var reporter = new ClassReporter();
        var report = reporter.generateMethodSummaryReport("src/test/resources/spoon/SpoonClassToTest.java");
        assertThat(report).isNotNull();
