...
import org.baeldung.config.PersistenceJNDIConfig;
...
@ContextConfiguration(classes = { PersistenceJNDIConfig.class }, loader = AnnotationConfigContextLoader.class)
public class JndiPersistenceIntegrationTest {
