package com.baeldung.hexagonalarchitecture.adapter.web;
...
import com.baeldung.hexagonalarchitecture.domain.ParkingLotUseCase;
...
class ParkingLotControllerTest {
    ...
    void whenParkAPICalled_thenReturnParkingLotFromUseCase() throws Exception {
        ...
        mockMvc.perform(post("/parking-lot/{parkingLotId}/park", parkingLotId.toString()).contentType(MediaType.APPLICATION_JSON)
    ...
    void whenUnParkAPICalled_thenReturnParkingLotFromUseCase() throws Exception {
        ...
        mockMvc.perform(delete("/parking-lot/{parkingLotId}/un-park", parkingLotId.toString()).contentType(MediaType.APPLICATION_JSON)
            .content(objectMapper.writeValueAsString(CAR)))
            .andDo(print())
            .andExpect(status().isOk())
            .andExpect(content().json(objectMapper.writeValueAsString(parkingLot)));
    ...
    void whenCreateAPICalled_thenReturnParkingLotFromUseCase() throws Exception {
        ...
        mockMvc.perform(post("/parking-lot/").param("capacity", String.valueOf(capacity))
    ...
    void whenGetAPICalled_thenReturnParkingLotFromUseCase() throws Exception {
        ...
        mockMvc.perform(get("/parking-lot/{parkingLotId}", parkingLotId.toString()).contentType(MediaType.APPLICATION_JSON))
            .andDo(print())
            .andExpect(status().isOk())
            .andExpect(content().json(objectMapper.writeValueAsString(parkingLot)));
    }
