...
public class UseTimeZone {
    ...
    public static ZoneId setTimeZoneUsingJava8(String timeZone) {
        ...
        System.out.println(String.format("Java8: Time now in '%s' is '%s'", nowAsiaSingapore.getZone(), nowAsiaSingapore.format(DateTimeFormatter.ofPattern(PATTERN))));
    ...
    public static DateTimeZone setTimeZoneUsingJodaTime(String timeZone) {
        ...
        System.out.println(String.format("Joda-time: Time now in '%s' is '%s'", nowAsiaSingapore.getZone(), nowAsiaSingapore.toString(PATTERN)));
