...
<xsl:stylesheet
        ...
        <refparameter>
            <variablelist>
                <varlistentry>
                    ...
                    <listitem>
                        <para>Displays <tag>funcprototype</tag> output in K&amp;R style
                        </para>
                    </listitem>
                </varlistentry>
                <varlistentry>
                    ...
                    <listitem>
                        <para>Displays <tag>funcprototype</tag> output in ANSI style
                        </para>
                    </listitem>
                </varlistentry>
            </variablelist>
    ...
    <doc:pi name="dbfo_glossary-presentation" xmlns="">
        ...
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo glossary-presentation</tag> PI as a child of
                a <tag>glossary</tag> to control its presentation style.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
    ...
    <doc:pi name="dbfo_glosslist-presentation" xmlns="">
        ...
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo glosslist-presentation</tag> PI as a child of
                a <tag>glosslist</tag> to control its presentation style.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
    ...
    <doc:pi name="dbfo_glossterm-width" xmlns="">
        ...
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo glossterm-width</tag> PI as a child of a
                <tag>glossary</tag>
                or <tag>glosslist</tag> to specify the
    ...
    <doc:pi name="dbfo_label-width" xmlns="">
        ...
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo label-width</tag> PI as a child of a
                ...
                or <tag>calloutlist</tag> to specify the width of labels.
            </para>
        </refdescription>
        <refsynopsisdiv>
            <synopsis>
        ...
        <refparameter>
            <variablelist>
                ...
                <varlistentry>
                    ...
                    <listitem>
                        <para>(<tag>variablelist</tag> only) Displays the list as blocks
                        </para>
                    </listitem>
                </varlistentry>
                <varlistentry>
        ...
        <refparameter>
            <variablelist>
                <varlistentry>
                    ...
                    <listitem>
                        <para>Specifies the <tag>simplelist</tag> width (including units)
                        </para>
                    </listitem>
                </varlistentry>
            </variablelist>
    ...
    <doc:pi name="dbfo_pgwide" xmlns="">
        <refpurpose>Specifies if an <tag>equation</tag> or <tag>example</tag> goes across full page width
        </refpurpose>
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo pgwide</tag> PI as a child of an
                <tag>equation</tag>
                or <tag>example</tag> to specify that the
    ...
    <doc:pi name="dbfo_rotated-width" xmlns="">
        ...
        <refdescription>
            <para>Use the <tag class="xmlpi">dbfo rotated-width</tag> PI as a child of
                <tag>entry</tag>
                or <tag>row</tag> instance in a CALS table to specify the
        ...
        <refparameter>
            <variablelist>
                <varlistentry>
                    ...
                    <listitem>
                        <para>Specifies the <tag>sidebar</tag> width (including units)
                        </para>
                    </listitem>
                </varlistentry>
            </variablelist>
