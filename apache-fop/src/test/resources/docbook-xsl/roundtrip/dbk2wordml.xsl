<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/" name='wordml.top'>
        ...
        <xsl:variable name='authors'
                      select='$info/author|$info/authorinitials|$info/authorgroup/author|$info/authorgroup/editor'/>
                    ...
                    <xsl:variable name="content">
                        <xsl:choose>
                            <xsl:when test='$info/revhistory/revision[1]/*[self::author|self::authorinitials]'>
                                <xsl:apply-templates
                                        select='$info/revhistory/revision[1]/*[self::author|self::authorinitials]'
