<xsl:stylesheet version="1.0"
    ...
    <xsl:template name='rnd:find-style'>
        ...
        <xsl:choose>
            ...
            <xsl:when
                    test='key("styles", $ident)/self::sf:characterstyle/sf:property-map/sf:superscript/sf:number/@sfa:number = "1"'>
                superscript
            </xsl:when>
            <xsl:when
                    test='key("styles", $ident)/self::sf:characterstyle/sf:property-map/sf:subscript/sf:number/@sfa:number = "1"'>
                subscript
            </xsl:when>
