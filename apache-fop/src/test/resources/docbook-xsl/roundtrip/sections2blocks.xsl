...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:dbk="http://docbook.org/ns/docbook"
    ...
    <axsl:template
        ...
        <axsl:variable name="subsections"
                       select="dbk:para[@rnd:style = &quot;bibliography&quot; or @rnd:style = &quot;bibliography-title&quot; or @rnd:style = &quot;glossary&quot; or @rnd:style = &quot;glossary-title&quot; or @rnd:style = &quot;qandaset&quot; or @rnd:style = &quot;qandaset-title&quot;]"/>
        <axsl:copy>
            ...
            <axsl:when test="@rnd:style = &quot;bibliography&quot; or @rnd:style = &quot;bibliography-title&quot;">
                <bibliography xmlns="http://docbook.org/ns/docbook">
                    ...
                    <axsl:variable name="bibliodivs"
                                   select="following-sibling::dbk:para[@rnd:style = &quot;bibliodiv&quot; or @rnd:style = &quot;bibliodiv-title&quot;]"/>
                    <axsl:choose>
            ...
            <axsl:when test="@rnd:style = &quot;glossary&quot; or @rnd:style = &quot;glossary-title&quot;">
                <glossary xmlns="http://docbook.org/ns/docbook">
                    ...
                    <axsl:variable name="glossdivs"
                                   select="following-sibling::dbk:para[@rnd:style = &quot;glossdiv&quot; or @rnd:style = &quot;glossdiv-title&quot;]"/>
                    <axsl:choose>
            ...
            <axsl:when test="@rnd:style = &quot;qandaset&quot; or @rnd:style = &quot;qandaset-title&quot;">
                <qandaset xmlns="http://docbook.org/ns/docbook">
                    ...
                    <axsl:variable name="qandadivs"
                                   select="following-sibling::dbk:para[@rnd:style = &quot;qandadiv&quot; or @rnd:style = &quot;qandadiv-title&quot;]"/>
                    <axsl:choose>
