...
public class JsonJava7Test {
    ...
    public void whenPersonIsConvertedToString_thenAValidJsonStringIsReturned() throws IOException {
        ...
        assertEquals("Generated String has the expected format and content", personJson, generatedJsonString);
    }
    ...
    public void whenUsingObjectModelToQueryForSpecificProperty_thenExpectedValueIsReturned() throws IOException, ParseException {
        ...
        assertEquals("The query should return the 'name' property of the third pet from the list", "Jake", jsonObject.getJsonArray("pets").getJsonObject(2).getString("name"));
    }
