package org.baeldung.bootTest.service;
...
public class FooService {
    ...
    public ResponseEntity<?> getFooWithId(@PathVariable Long id) {
    ...
    public ResponseEntity<?> getFooWithId(@RequestParam String name) {
